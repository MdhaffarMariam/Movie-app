...
// const filtrer = ()=> setMovie(movie.filter(el=>el.title.toLowerCase().includes(text.toLowerCase())) )
  return (
    <div className="App">
       <header>
        <h1> My movie app</h1>
    ...
    <MovieCard movie={data.filter(el=>el.title.toLowerCase().includes(text.toLowerCase())) }  text={text}/>
